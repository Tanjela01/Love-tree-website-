...
//     print_r($pro_img);
    ...
    if(in_array($procheck,$filestored))
    {
        ...
        $sql="INSERT INTO `product_item`(`pro_name`,`description`, `pro_price`,`pro_cat`,`pro_img`) VALUES ('$pro_name','$pro_desc','$pro_price','$pro_cat','$filelocation')";
...
<body>
  ...
  <section class="home-section">
    ...
    <form action="additem.php" class="needs-validation" method="post" enctype="multipart/form-data">
      <h1>ADD ITEM</h1>
      <div class="mb-3 col-8">
        <label for="Name" class="form-label">Name</label>
        <input type="name" name="Name" class="form-control" id="Name" aria-describedby="emailHelp" placeholder="Name" required >
      </div>
      ...
      <div class="mb-3 col-8">
        ...
        <input type="number" name="price" class="form-control" id="price" aria-describedby="emailHelp" placeholder="Price" required>
      </div>
      <div class="mb-2 col-8">
          <label for="price" class="form-label">Catogory</label>
      ...
      <div class="mb-3 col-8">
        ...
        <input type="file" name="myfile" class="form-control-file" id="myfile">
