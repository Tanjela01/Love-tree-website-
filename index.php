...
<div style="max-width:100%;">
        <img class="mySlides slideshow" src="img/1.gif" style="width:100%">
        <img class="mySlides slideshow" src="img/2.gif" style="width:100%">
        <img class="mySlides slideshow" src="img/3.gif" style="width:100%">
    </div>
    ...
    <center><h1 class="my-4">TREANDING</h1></center>
    <div class="container">
        <?php
        require 'database/dbconn.php';
        ...
        while($result=mysqli_fetch_array($res)){
            ?>    
            <form action="component/treeblog.php" method="GET">
